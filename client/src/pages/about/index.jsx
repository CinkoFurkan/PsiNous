                  ...
                  <div className="flex flex-row-reverse items-center justify-between w-full mb-8 left-timeline">
                    ...
                    <div className="order-1 w-5/12 px-1 py-4 text-right">
                      ...
                      <p className="text-sm leading-snug text-black md:text-base">
                        PsiNous, 2023 yılında Psikoloji Bölümü öğrencileri
                        Zeynep Keçe ve Zeynep Öztuğcu tarafından kurulan; ruh
                        sağlığı alanında eğitim gören öğrencilerin mesleki
                        gelişimlerine katkı sunmayı amaçlayan, kâr amacı
                        gütmeyen bir öğrenci topluluğudur.
                        <br />
                        <br />
                        PsiNous olarak amacımız, ruh sağlığı alanındaki
                        öğrencilerin bilgi ve farkındalık düzeylerini artırarak
                        akademik ve mesleki donanımlarını geliştirmektir. Bu
                        doğrultuda düzenlediğimiz çeşitli eğitim, seminer ve
                        etkinliklerle öğrencilerin mesleki gelişimlerini
                        desteklerken; onları sahada aktif, bilinçli ve etkili
                        profesyoneller olmaları için teşvik ediyoruz.
                        <br />
                        <br />
                        PsiNous olarak, özgün, yenilikçi ve nitelikli
                        etkinliklerle öğrencilerin bu alanda yetkin bireyler
                        olmalarına, aynı zamanda mesleki etik ve bilinç
                        kazanmalarına da önem veriyoruz. Ayrıca topluluğumuzun
                        tüm üyelerinin bir arada üretim yapabileceği ve
                        deneyimlerini paylaşabileceği bir ortam oluşturmayı
                        amaçlıyoruz.
                      </p>
                    </div>
                  </div>
