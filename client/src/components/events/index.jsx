          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col items-center w-full p-6 space-y-3">
                <h2 className="text-2xl font-semibold text-gray-900 line-clamp-1">{event.title}</h2>
                
                <p className="text-gray-700 text-sm line-clamp-3 flex-grow h-16 overflow-hidden">
                  {event.description}
                </p>
                ...
                <Button
                  ...
                  variant="primary"
                  size="normal"
                  className="mt-4 w-3/4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-center transition-colors duration-300"
                >
